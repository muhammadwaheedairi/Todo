...
const HomePage: React.FC<HomePageProps> = ({ onGetStarted, onLogin }) => {
  return (
    <div className="min-h-screen bg-white font-inter selection:bg-[#F45B5B]/30 scroll-smooth">
      {/* Premium Gradient Background Blobs */}
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none overflow-hidden -z-10">
        <div className="absolute top-[-10%] right-[-10%] w-[600px] h-[600px] bg-[#F45B5B]/5 rounded-full blur-[120px]"></div>
        <div className="absolute bottom-[10%] left-[-5%] w-[500px] h-[500px] bg-[#3BAFDA]/5 rounded-full blur-[100px]"></div>
      </div>
      ...
      <section className="pt-44 pb-24 px-4">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <div className="inline-flex items-center gap-2 bg-gray-900 text-white px-5 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.2em] mb-10 shadow-xl shadow-gray-200">
          ...
          <p className="text-lg md:text-2xl text-gray-500 mb-14 max-w-3xl leading-relaxed font-medium">
